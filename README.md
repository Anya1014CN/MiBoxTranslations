...
3. Then create a new file with a name in the format "language.ini", e.g. "English.ini", "¼òÌåÖÐÎÄ.ini", etc. Please do not include spaces in the name, if you need spaces, please use "_" to connect, e.g. "Bahasa_Indonesia.ini"
